...
class produceJoinOrderingVOID {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<HashSet<Triple>> bgps = evaluateSPARQLQuery.getBGPs(query);
        ...
        for (HashSet<Triple> bgp : bgps) {
            HashSet<Triple> ts = new HashSet<Triple>(bgp);
        ...
        evaluateSPARQLQuery.endpoints = endpoints;
        Query newQuery = evaluateSPARQLQuery.produceQueryWithServiceClauses(query, plans);
        if (newQuery != null) {
            String plan = newQuery.toString(); //produceJoinOrderingFederation.toString(res.getFirst(), distinct, projectedVariables, endpoints);
